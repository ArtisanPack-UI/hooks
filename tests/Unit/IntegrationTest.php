...
test('service provider correctly registers singletons', function () {
...
test('helper functions for actions work correctly', function () {
	$result = 'initial';

	// Use the global helper to add the action.
	addAction('helper_action', function ($arg) use (&$result) {
		$result = $arg;
	});
...
test('helper functions for filters work correctly', function () {
...
test('blade action directive compiles correctly', function () {
...
test('blade filter directive compiles correctly', function () {
